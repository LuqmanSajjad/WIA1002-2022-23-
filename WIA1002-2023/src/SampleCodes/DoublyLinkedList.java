...
public class DoublyLinkedList<E> {
    ...
    public void add(int index, E element){
		...
		if(index == 0)
			...
			addLast(element);
                        ...
                        stop on !! required position !!*/ // singly linked list stops before the required index.
			Node<E> temp = head;
   ...
   /*
   Assigning both the head and tail to null 
   could also works, but the pointer of 
   all the nodes is still not deleted 
   */
    public void clear(){
		Node<E> temp = head;
		while(head != null){
